			...
			<div class="row features-inner">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<i class="fas fa-gem"></i>
						<h6>Pierres Précieuses</h6>
						<p>Qualité et authenticité garanties</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<i class="fas fa-paint-brush"></i>
						<h6>Création Unique</h6>
						<p>Des bijoux faits à la main</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<i class="fas fa-leaf"></i>
						<h6>Lithothérapie</h6>
						<p>Énergie et bien-être au quotidien</p>
					</div>
				</div>
				<!-- single features -->
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<i class="fas fa-hand-holding-heart"></i>
						<h6>Artisanat Passion</h6>
						<p>Chaque pièce a une âme</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row justify-content-center">
					...
					<div class="row">
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<img class="img-fluid w-50" src="img/category/c1.jpg" alt="">
								<a href="img/category/c1.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Bagues</h6>
									</div>
								</a>
							</div>
						</div>
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<a href="img/category/c2.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Colliers</h6>
									</div>
								</a>
							</div>
						</div>
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								...
								<a href="img/category/c3.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Porte clé</h6>
									</div>
								</a>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-deal">
						...
						<a href="img/category/c1.jpg" class="img-pop-up" target="_blank">
							<div class="deal-details">
								<h6 class="deal-title">Bracelets</h6>
							</div>
						</a>
					</div>
				</div>
