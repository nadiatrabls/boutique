            ...
            <?php foreach ($autresProduits as $autreProduit): ?>
                <div class="col-lg-4 col-md-4 col-sm-6 mb-20">
                    <div class="single-related-product d-flex">
                        <a href="single-product.php?id=<?php echo $autreProduit->id; ?>">
                        ...
                        <div class="desc">
                            <a href="single-product.php?id=<?php echo $autreProduit->id; ?>" class="title"> <?php echo htmlspecialchars($autreProduit->nom); ?></a>
                            <div class="price">
